...
export const OBRAS: Obra[] = [
  {
    ...
    seaceUrl: '#',
    partidas: [
      { id: 'p1', insumo: 'Cemento Portland Tipo I', unidad: 'BOL', cantidad: 2400, precioDeclarado: 38.5, precioReferencia: 24.0, ratio: 1.60, fuente: 'INEI' },
      ...
      { id: 'p3', insumo: 'Arena gruesa', unidad: 'M3', cantidad: 320, precioDeclarado: 95.0, precioReferencia: 55.0, ratio: 1.73, fuente: 'INEI' },
      { id: 'p4', insumo: 'Piedra chancada 1/2"', unidad: 'M3', cantidad: 280, precioDeclarado: 115.0, precioReferencia: 68.0, ratio: 1.69, fuente: 'INEI' },
      { id: 'p5', insumo: 'Mano de obra operario', unidad: 'HH', cantidad: 9600, precioDeclarado: 21.0, precioReferencia: 19.5, ratio: 1.08, fuente: 'MVCS' },
    ],
    scoreDetalle: [
