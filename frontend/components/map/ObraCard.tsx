  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-4 hover:shadow-md transition-shadow h-full flex flex-col">
      ...
      <div className="flex flex-wrap gap-1.5 mb-3">
        <span className={`text-[11px] px-2 py-0.5 rounded-full font-medium ${ESTADO_COLOR[obra.estado]}`}>
          {obra.estado}
        </span>
      ...
      {!compact && (
        <>
          <RiskMeter score={obra.score} size="sm" />
          <div className="mt-3 space-y-1.5">
            <div className="flex items-center gap-1.5 text-[12px] text-gray-400 font-light">
              ...
              <span>{obra.region}, {obra.departamento}</span>
            </div>
            <div className="flex items-center gap-1.5 text-[12px] text-gray-400 font-light">
